...
class Game:
    ...
    def draw(self):
        ...
        if self.state == self.game_main:
            self.game_main.draw(self.screen,self.events)
...
class GameMain:
    ...
    def draw(self, screen,events):
        ...
        # next turn button-----------------------------------------------------------------------------------------
        screen.blit(self.next_turn, (width * 0.8, heigth * 0.85))
...
class Turn:
    ...
    def draw(self,screen):
        message_to_screen("current Turn: {}".format(self.turn_number),screen,width*0.85,heigth*0.05,20)
