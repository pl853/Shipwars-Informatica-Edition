...
class Game:
    def __init__(self):
        ...
        self.ship1 = Boats(heigth*0.040, width*0.4583,30,133,"boat1",3,2,"battleship1.png",self.turn)
        self.ship2 = Boats(heigth*0.040,width*0.511,20,100,"boat2",3,3,"battleship2.png",self.turn)
        self.ship3 = Boats(heigth * 0.040,width*0.562,20,100,"boat3",3,3,"battleship.png",self.turn)
        self.ship4 = Boats(heigth * 0.79, width * 0.46, 30, 130, "boat1", 3, 2, "battleship5.png",self.turn)
        self.ship5 = Boats(heigth * 0.83, width * 0.512, 20, 100, "boat2", 3, 3, "battleship6.png",self.turn)
        self.ship6 = Boats(heigth * 0.83, width * 0.564, 20, 100, "boat3", 3, 3, "battleship4.png",self.turn)
...
class GameMain:
    def __init__(self, game , turn , cards):
        ...
        self.ohealth = pygame.image.load("healthoff.jpg")
        self.ohealth = pygame.transform.scale(self.ihealth, [30, 30])
    ...
    def draw(self, screen):
        ...
        if self.turn.turn_number%2 == 1:
            if self.game.ship4.lead_y - self.game.ship4.height - (self.block_size_up_down*3)<self.game.ship1.lead_y and self.game.ship4.lead_x >= self.game.ship1.lead_x and self.game.ship4.lead_x < self.game.ship1.lead_x + self.game.ship1.width:
            ...
            if self.game.ship4.lead_y - self.game.ship4.height - (self.block_size_up_down*2)<self.game.ship2.lead_y and self.game.ship4.lead_x >= self.game.ship2.lead_x and self.game.ship4.lead_x < self.game.ship2.lead_x + self.game.ship2.width:
            ...
            if self.game.ship4.lead_y - self.game.ship4.height - (self.block_size_up_down*2)<self.game.ship3.lead_y and self.game.ship4.lead_x >= self.game.ship3.lead_x and self.game.ship4.lead_x < self.game.ship3.lead_x + self.game.ship3.width:
            ...
            if self.game.ship5.lead_y - self.game.ship5.height - (self.block_size_up_down*3)<self.game.ship1.lead_y and self.game.ship5.lead_x >= self.game.ship1.lead_x and self.game.ship5.lead_x < self.game.ship1.lead_x + self.game.ship1.width:
            ...
            if self.game.ship5.lead_y - self.game.ship5.height - (self.block_size_up_down*2)<self.game.ship2.lead_y and self.game.ship5.lead_x >= self.game.ship2.lead_x and self.game.ship5.lead_x < self.game.ship2.lead_x + self.game.ship2.width:
                mouse_button_pressed(width * 0.09, heigth * 0.435, 170, 90, screen, self.attack_button, self.game.events,lambda:subtract_health_2(self,screen))

            if self.game.ship5.lead_y - self.game.ship5.height - (self.block_size_up_down*2)<self.game.ship3.lead_y and self.game.ship5.lead_x >= self.game.ship3.lead_x and self.game.ship5.lead_x < self.game.ship3.lead_x + self.game.ship3.width:
                mouse_button_pressed(width * 0.09, heigth * 0.435, 170, 90, screen, self.attack_button, self.game.events,lambda:subtract_health_3(self,screen))

            if self.game.ship6.lead_y - self.game.ship6.height - (self.block_size_up_down*2)<self.game.ship1.lead_y and self.game.ship6.lead_x >= self.game.ship1.lead_x and self.game.ship6.lead_x < self.game.ship1.lead_x + self.game.ship1.width:
            ...
            elif self.game.ship6.lead_y - self.game.ship6.height - (self.block_size_up_down*2)<self.game.ship2.lead_y and self.game.ship6.lead_x >= self.game.ship2.lead_x and self.game.ship6.lead_x < self.game.ship2.lead_x + self.game.ship2.width:
                mouse_button_pressed(width * 0.09, heigth * 0.744, 170, 90, screen, self.attack_button, self.game.events,lambda:subtract_health_2(self,screen))

            if self.game.ship6.lead_y - self.game.ship6.height - (self.block_size_up_down*2)<self.game.ship3.lead_y and self.game.ship6.lead_x >= self.game.ship3.lead_x and self.game.ship6.lead_x < self.game.ship3.lead_x + self.game.ship3.width:
                mouse_button_pressed(width * 0.09, heigth * 0.744, 170, 90, screen, self.attack_button, self.game.events,lambda:subtract_health_3(self,screen))

        elif self.turn.turn_number %2 == 0:
            if self.game.ship1.lead_y + self.game.ship1.height + (self.block_size_up_down*3)> self.game.ship4.lead_y and self.game.ship1.lead_x+10 >= self.game.ship4.lead_x and self.game.ship1.lead_x < self.game.ship4.lead_x + self.game.ship4.width :
                mouse_button_pressed(width * 0.09, heigth * 0.13, 170, 90, screen, self.attack_button, self.game.events,
...
# def collision():
#     if self.ship4.lead_y  > self.ship1.lead_y + self.ship1.height:
#         pass
