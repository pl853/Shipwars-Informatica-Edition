...
class GameMain:
    ...
    def draw(self, screen):
        ...
        def rotate_inactive(self):
            self.rotateinactive = True
        ...
        if self.turn.turn_number % 2 == 0:
            if self.game.ship1.rotatea == 0:
                if self.game.ship1.lead_x+self.game.ship1.height > self.game.ship4.lead_x and self.game.ship1.lead_x<self.game.ship4.lead_x+self.game.ship4.width and self.game.ship1.lead_y+(self.block_size_up_down*3)>self.game.ship4.lead_y:
