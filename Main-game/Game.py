...
class Game:
    def __init__(self):
        ...
        self.ship1 = Boats(heigth*0.040,width*0.644,30,133,"boat1",3,3,"battleship1.png")
        self.ship2 = Boats(heigth*0.040,width*0.698,20,100,"boat2",3,3,"battleship2.png")
...
class GameMain:
    ...
    def draw(self, screen):
        ...
        # menu button---------------------------------------------------------------------------------------------
        mouse_button_pressed(1200, 10, 50, 50, screen, self.pbutton,
                             lambda: self.game.set_state(self.game.pause_menu))
        # rotate buttons------------------------------------------------------------------------------------------
        mouse_button_pressed(10, 10, 130, 50, screen, self.abutton,
                             lambda: self.game.ship1.rotate(90))
        mouse_button_pressed(10, 240, 130, 50, screen, self.abutton,
                             lambda: self.game.ship2.rotate(90))
        mouse_button_pressed(10, 470, 130, 50, screen, self.abutton,
                             lambda: self.game.ship1.rotate(90))
        # movement buttons ship1-----------------------------------------------------------------------------------
        mouse_button_pressed(width*0.03, heigth*0.115, 40, 20, screen, self.emptyimage,
                             lambda: self.game.ship1.move_down())
        mouse_button_pressed(width * 0.03, heigth * 0.18, 40, 30, screen, self.emptyimage,
                             lambda: self.game.ship1.move_up())
        mouse_button_pressed(width * 0.05, heigth * 0.147, 40, 20, screen, self.emptyimage,
                             lambda: self.game.ship1.move_right())
        mouse_button_pressed(width * 0.01, heigth * 0.147, 40, 20, screen, self.emptyimage,
                             lambda: self.game.ship1.move_left())

        # movement buttons ship2-----------------------------------------------------------------------------------
        mouse_button_pressed(width * 0.03, heigth * 0.42, 40, 20, screen, self.emptyimage,
                             lambda: self.game.ship2.move_down())
        mouse_button_pressed(width * 0.03, heigth * 0.49, 40, 30, screen, self.emptyimage,
                             lambda: self.game.ship2.move_up())
        mouse_button_pressed(width * 0.05, heigth * 0.45, 40, 20, screen, self.emptyimage,
                             lambda: self.game.ship2.move_right())
        mouse_button_pressed(width * 0.01, heigth * 0.45, 40, 20, screen, self.emptyimage,
                             lambda: self.game.ship2.move_left())
        # next turn button-----------------------------------------------------------------------------------------
        mouse_button_pressed(1000, 635, 170, 80, screen, self.next_turn,
...
class PauseMenu:
    ...
    def draw(self, screen):
        ...
        mouse_button_pressed(width*0.4, heigth*0.5, 250, 50, screen, self.pbuttom,
                             lambda: self.game.set_state(self.game.game_main))
        mouse_button_pressed(width*0.4, heigth*0.8, 250, 50, screen, self.qbuttom,
                             lambda: sys.exit())
        mouse_button_pressed(width*0.4, heigth*0.6, 250, 50, screen, self.ibuttom)
        mouse_button_pressed(width * 0.4, heigth * 0.7, 250, 50, screen, self.bmenu,
