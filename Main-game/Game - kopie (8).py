...
class GameMain:
    ...
    def draw(self, screen):
        ...
        if self.turn.turn_number%2 == 1:
            ...
            if self.game.ship1.lead_y + self.game.ship1.height + (self.block_size_up_down * 3) > self.game.ship5.lead_y and self.game.ship1.lead_x + 10 >= self.game.ship5.lead_x and self.game.ship1.lead_x < self.game.ship5.lead_x + self.game.ship5.width and self.game.ship1.lead_y   + self.game.ship1.height <= self.game.ship5.lead_y or self.game.ship1.lead_x + self.game.ship1.width + (self.block_size * 3) > self.game.ship5.lead_x and self.game.ship1.lead_x + self.game.ship1.width < self.game.ship5.lead_x and self.game.ship1.lead_y  + self.game.ship1.height   > self.game.ship5.lead_y  and self.game.ship1.lead_y - self.game.ship1.height < self.game.ship5.lead_y -30 or self.game.ship1.lead_x - (self.block_size * 3) < self.game.ship5.lead_x and self.game.ship1.lead_x > self.game.ship5.lead_x and self.game.ship1.lead_y + self.game.ship1.height > self.game.ship5.lead_y and self.game.ship1.lead_y < self.game.ship5.lead_y + self.game.ship5.height - 10:
